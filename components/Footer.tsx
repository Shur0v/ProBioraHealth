        ...
        <div className="grid lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-1">
             <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-probiora-800 font-bold text-xl">P</div>
                <span className="text-xl font-black tracking-tight uppercase">ProBiora<span className="text-probiora-300 font-light">Health</span></span>
             </div>
